...
<p align="center">
  <img src="docs/vts-how-it-works.png" alt="vs-token-safer는 하나의 정밀도 사다리로 답합니다: EXACT(시맨틱 언어 서버) → SYNTACTIC(tree-sitter, 무설정) → FUZZY(개념 사전, 임베딩 없음) → SECTION(문서/설정, 헤딩 기준). 모든 답은 file:line으로 캡되고 어느 단에서 나왔는지 라벨이 붙습니다 — grep 대비 토큰 87% 절감" width="900">
</p>
