...
- **LARGER: Lexically Anchored Repository Graph Exploration and Retrieval** — Hu et al., [arXiv:2605.16352](https://arxiv.org/abs/2605.16352). "어휘 앵커 → 구조적 확장"을 정식화 — 임베딩 없이 동작하는, 우리 퍼지→exact 갈아타기 사다리의 학술적 형태.
...
- **cAST: Abstract Syntax Tree 기반 구조적 청킹** — Zhang et al., [arXiv:2506.15655](https://arxiv.org/abs/2506.15655). 코드 RAG용 tree-sitter 청킹 — 우리 SYNTACTIC 티어의 이웃.
